...
class ReviewCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $definition->addOption(new InputOption('--adapter', '', InputOption::VALUE_REQUIRED, 'Specify the adapter to use'));
        $definition->addOption(new InputOption('--formatter', '', InputOption::VALUE_REQUIRED, 'Specify the format of the output'));
        $definition->addOption(new InputOption('--review', '', InputOption::VALUE_REQUIRED | InputOption::VALUE_IS_ARRAY, 'Specify the reviews to use'));
